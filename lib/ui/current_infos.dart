...
class CurrentInfos extends StatelessWidget {
  ...
  const CurrentInfos(
      {super.key, required this.location, required this.current});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      infos(
                          Icons.water_drop, "${current?.precipitation ?? 0}mm"),
                      infos(Icons.visibility, "${current?.visibility ?? 0}kms"),
                      infos(Icons.sunny, "uv: ${current?.uv ?? 0}")
                    ],
                  ),
                  const SizedBox(
                    height: 16,
